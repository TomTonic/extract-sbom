...
func FuzzValidateEntry(f *testing.F) {
	...
	f.Add("device", int64(0), int64(0), false, false, uint32(0o666|os.ModeDevice))
	f.Add("dir/", int64(0), int64(0), true, false, uint32(0o755))
	f.Add("", int64(-1), int64(-1), false, false, uint32(0))
	f.Add("x", ^int64(0)>>1, int64(1), false, false, uint32(0o644)) // MaxInt64

	f.Fuzz(func(_ *testing.T, name string, uncompSize int64, compSize int64, isDir bool, isSymlink bool, rawMode uint32) {
