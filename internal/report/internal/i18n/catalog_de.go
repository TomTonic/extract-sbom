...
func german() Bundle {
	return Bundle{
		...
		SuppressionDescriptionFSArtifact:    "Datei-Syft-Eintrag ohne Paketidentitaet. Kein Triage-Handlungsbedarf.",
		SuppressionDescriptionLowValueFile:  "Keine PURL, keine Version, keine Cataloger-Metadaten. Nicht CVE-korrelierbar.",
		SuppressionDescriptionWeakDuplicate: "Am selben Ort existierte ein staerkerer Paketeintrag; dieser Platzhalter wurde entfernt.",
		SuppressionDescriptionPURLDuplicate: "Gleiche Paketidentitaet mehrfach beschrieben. Eine Repraesentation beibehalten.",
