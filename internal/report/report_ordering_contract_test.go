...
// TestCrossReportOrderingContractHTMLVulnerabilities verifies that HTML
// vulnerability rows are sorted by vulnerability ID and then bom-ref.
func TestCrossReportOrderingContractHTMLVulnerabilities(t *testing.T) {
	t.Parallel()
